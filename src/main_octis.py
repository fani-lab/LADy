import argparse, os, pickle, multiprocessing, json, time, string
...
def main(args):
    ...
    if 'train' in params.settings['cmd']:
        ...
        if "lda" == args.am: from octis.models.LDA import LDA; am = LDA(num_topics=args.naspects)
